...
from modeling_ir_2 import BertForIRForPreTraining, BertForIRConfig, WEIGHTS_NAME, CONFIG_NAME
...
def main():
    ...
    parser.add_argument("--num_relevant_attention_head",
                        default=3,
                        type=int,
                        help="Number of rel-attention heads that is replaced to attention layer")
